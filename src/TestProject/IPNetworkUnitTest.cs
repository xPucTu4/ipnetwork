...
namespace System.Net.TestProject
{
    ...
    public class IPNetworkUnitTest
    {
        ...
        {
            new IPNetwork3.IPNetwork(BigInteger.Zero, Sockets.AddressFamily.InterNetwork, 33);
        }
        #endregion
        ...
        {
            IPAddress ip = null;
            IPNetwork3.IPNetwork.Parse(ip, ip);
        }
        ...
        {
            IPNetwork3.IPNetwork.Parse(string.Empty, 0);
        }
        ...
        {
            IPNetwork3.IPNetwork.Parse((string)null, 0);
        }
        ...
        {
            string n = null;
            IPNetwork3.IPNetwork.Parse(n, n);
        }
        ...
        {
            var ipnet = IPNetwork3.IPNetwork.Parse("x.x.x.x", "x.x.x.x");
        }
        ...
        {
            var ipnet = IPNetwork3.IPNetwork.Parse("0.0.0.0", "x.x.x.x");
        }
        ...
        {
            var ipnet = IPNetwork3.IPNetwork.Parse("x.x.x.x", 0);
        }
        ...
        {
            var ipnet = IPNetwork3.IPNetwork.Parse("0.0.0.0", 33);
        }
        ...
        public void TestParseIPAddressNetmask()
        {
            ...
            var ipnetwork = IPNetwork3.IPNetwork.Parse(ipaddress, netmask);
        ...
        public void TestParseString1()
        {
            ...
            var ipnetwork = IPNetwork3.IPNetwork.Parse(ipaddress);
            Assert.AreEqual(network, ipnetwork.Network.ToString(), "Network");
            Assert.AreEqual(netmask, ipnetwork.Netmask.ToString(), "Netmask");
            Assert.AreEqual(broadcast, ipnetwork.Broadcast.ToString(), "Broadcast");
            Assert.AreEqual(cidr, ipnetwork.Cidr, "Cidr");
        ...
        public void TestParseIPAddressNoNetmask1_ClassFull()
        {
            ...
            var ipnetwork = IPNetwork3.IPNetwork.Parse(ipaddress, guessCidr);
        ...
        public void TestParseIPAddressNoNetmask127001()
        {
            ...
            IPNetwork3.IPNetwork result = null;
            IPNetwork3.IPNetwork.TryParse(ipaddress, out result);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            IPAddress ip = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(ip, ip, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(string.Empty, 0, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(null, 0, out ipnet);
        ...
        public void TestTryParseIPAddressNetmaskANE5()
        {
            string n = null;
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(n, n, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(IPAddress.Parse("10.10.10.10"), null, out ipnet);
            Assert.AreEqual(false, parsed, "parsed");
            Assert.AreEqual(null, ipnet, "ipnet");
        }
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", null, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse("x.x.x.x", "x.x.x.x", out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", "x.x.x.x", out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse("x.x.x.x", 0, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnet = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", 33, out ipnet);
        ...
        {
            IPNetwork3.IPNetwork ipnetwork = null;
            string ipaddress = "192.168.168.100";
            string netmask = "255.255.255.0";
            ...
            bool parsed = IPNetwork3.IPNetwork.TryParse(ipaddress, netmask, out ipnetwork);
        ...
        public void TestTryParseString1()
        {
            ...
            bool parsed = IPNetwork3.IPNetwork.TryParse(ipaddress, out ipnetwork);
            Assert.AreEqual(true, parsed, "parsed");
            Assert.AreEqual(network, ipnetwork.Network.ToString(), "Network");
            Assert.AreEqual(netmask, ipnetwork.Netmask.ToString(), "Netmask");
            Assert.AreEqual(broadcast, ipnetwork.Broadcast.ToString(), "Broadcast");
        ...
        public void ParseIpIp1()
        {
            ...
            var ipnetwork = IPNetwork3.IPNetwork.Parse(ip, netm);
            Assert.AreEqual("192.168.168.0/24", ipnetwork.ToString(), "network");
        }
        ...
        public void CtorWithIpAndCidr1()
        {
            string ipaddress = "192.168.168.100";
            var ip = IPAddress.Parse(ipaddress);
            var ipnetwork = new IPNetwork3.IPNetwork(ip, 24);
            Assert.AreEqual("192.168.168.0/24", ipnetwork.ToString(), "network");
        }
        ...
        {
            IPAddress ip = null;
            var ipnetwork = new IPNetwork(ip, 24);
        }
        ...
        public void CtorWithIpAndCidr3()
        {
            string ipaddress = "192.168.168.100";
            var ip = IPAddress.Parse(ipaddress);
            var ipnetwork = new IPNetwork(ip, 33);
        }
        ...
        {
            IPNetwork3.IPNetwork.ToCidr(null);
        }

        [TestMethod]
        public void TestToCidrAE()
        {
            byte cidr = IPNetwork3.IPNetwork.ToCidr(IPAddress.IPv6Any);
        ...
        {
            IPNetwork3.IPNetwork.ToCidr(IPAddress.Parse("6.6.6.6"));
        }
        ...
        public void TestToCidr32()
        {
            ...
            byte cidr = 32;
            int result = IPNetwork3.IPNetwork.ToCidr(mask);
        ...
        {
            byte? cidr = null;
            bool parsed = IPNetwork3.IPNetwork.TryToCidr(null, out cidr);
            Assert.AreEqual(false, parsed, "parsed");
        }
        ...
        {
            byte? cidr = null;
            bool parsed = IPNetwork3.IPNetwork.TryToCidr(IPAddress.IPv6Any, out cidr);
            Assert.AreEqual(true, parsed, "parsed");
        ...
        {
            byte? cidr = null;
            bool parsed = IPNetwork3.IPNetwork.TryToCidr(IPAddress.Parse("6.6.6.6"), out cidr);
            Assert.AreEqual(false, parsed, "parsed");
        }
        ...
        public void TestTryToCidr32()
        {
            ...
            var mask = IPAddress.Parse("255.255.255.255");
            byte result = 32;
            bool parsed = IPNetwork3.IPNetwork.TryToCidr(mask, out cidr);
        ...
        public void TestToBigInteger32()
        {
            ...
            var result = IPNetwork3.IPNetwork.ToBigInteger(mask);
        ...
        public void TestToBigInteger24()
        {
            ...
            BigInteger? result = IPNetwork3.IPNetwork.ToBigInteger(mask);
        ...
        {
            BigInteger? result = IPNetwork3.IPNetwork.ToBigInteger(null);
        }
        ...
        {
            IPAddress ip = null;
            BigInteger? result = IPNetwork3.IPNetwork.ToBigInteger(ip);
        }

        [TestMethod]
        public void TestToBigIntegerANE2()
        {
            BigInteger? result = IPNetwork3.IPNetwork.ToBigInteger(IPAddress.IPv6Any);
            uint expected = 0;
        ...
        {
            BigInteger result = IPNetwork3.IPNetwork.ToUint(33, Sockets.AddressFamily.InterNetwork);
        }

        [TestMethod]
        public void TestToBigIntegerByte2()
        {
            BigInteger result = IPNetwork3.IPNetwork.ToUint(32, Sockets.AddressFamily.InterNetwork);
        ...
        {
            BigInteger result = IPNetwork3.IPNetwork.ToUint(0, Sockets.AddressFamily.InterNetwork);
            uint expected = 0;
            Assert.AreEqual(expected, result, "result");
        }
        ...
        public void TestToBigIntegerInternal1()
        {
            ...
            IPNetwork3.IPNetwork.InternalToBigInteger(true, 33, Sockets.AddressFamily.InterNetwork, out result);
        ...
        {
            BigInteger? result = null;
            IPNetwork3.IPNetwork.InternalToBigInteger(true, 129, Sockets.AddressFamily.InterNetworkV6, out result);
            Assert.AreEqual(null, result, "result");
        }
        ...
        {
            BigInteger? result = null;
            IPNetwork3.IPNetwork.InternalToBigInteger(false, 129, Sockets.AddressFamily.InterNetworkV6, out result);
        }
        ...
        {
            BigInteger? result = null;
            IPNetwork3.IPNetwork.InternalToBigInteger(false, 32, Sockets.AddressFamily.AppleTalk, out result);
        }
        ...
        {
            BigInteger? result = null;
            IPNetwork3.IPNetwork.InternalToBigInteger(true, 32, Sockets.AddressFamily.AppleTalk, out result);
            Assert.AreEqual(null, result, "result");
        }
        ...
        {
            BigInteger? result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToUint(32, Sockets.AddressFamily.InterNetwork, out result);
        ...
        public void TestTryToBigInteger32()
        {
            ...
            uint uintMask = 0xffffffff;
            BigInteger? result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToBigInteger(mask, out result);
        ...
        {
            BigInteger? result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToBigInteger(null, out result);
        ...
        public void TestTryToBigIntegerANE3()
        {
            IPAddress ip = null;
            BigInteger? result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToBigInteger(ip, out result);
        ...
        {
            BigInteger? result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToBigInteger(IPAddress.IPv6Any, out result);
        ...
        public void TryToNetmask1()
        {
            ...
            bool parsed = IPNetwork3.IPNetwork.TryToNetmask(0, Sockets.AddressFamily.InterNetwork, out result);
        ...
        {
            IPAddress result = null;
            bool parsed = IPNetwork3.IPNetwork.TryToNetmask(33, Sockets.AddressFamily.InterNetwork, out result);
        ...
        public void ToNetmask32()
        {
            byte cidr = 32;
            string netmask = "255.255.255.255";
            string result = IPNetwork3.IPNetwork.ToNetmask(cidr, Sockets.AddressFamily.InterNetwork).ToString();
        ...
        {
            byte cidr = 0;
            string result = IPNetwork3.IPNetwork.ToNetmask(cidr, Sockets.AddressFamily.AppleTalk).ToString();
        }
        ...
        {
            IPAddress result;
            IPNetwork3.IPNetwork.InternalToNetmask(true, 0, Sockets.AddressFamily.AppleTalk, out result);
        ...
        public void TestToIPAddress()
        {
            ...
            var result = IPNetwork3.IPNetwork.ToIPAddress(ip, Sockets.AddressFamily.InterNetwork);
        ...
        {
            var ip = new BigInteger(0);
            var result = IPNetwork3.IPNetwork.ToIPAddress(ip, Sockets.AddressFamily.AppleTalk);
        }
        ...
        {
            bool resut = IPNetwork3.IPNetwork.InternalValidNetmask(BigInteger.Zero, Sockets.AddressFamily.AppleTalk);
        }
        ...
        public void TestValidNetmask0()
        {
            var mask = IPAddress.Parse("255.255.255.255");
            bool expected = true;
            bool result = IPNetwork3.IPNetwork.ValidNetmask(mask);
        ...
        public void TestBitsSet32()
        {
            ...
            uint bits = 32;
            uint result = IPNetwork3.IPNetwork.BitsSet(ip);
        ...
        {
            IPNetwork3.IPNetwork network1 = null;
            IPNetwork3.IPNetwork network2 = null;

#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.Overlap(network1, network2);
#pragma warning restore 0618
        ...
        {
            IPNetwork3.IPNetwork network1 = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
            IPNetwork3.IPNetwork network2 = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
...
#pragma warning restore 0618
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("10.0.0.0/0");
            IPNetwork3.IPNetwork network2 = null;
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("10.0.0.0/0");
            var network2 = IPNetwork3.IPNetwork.Parse("10.0.0.0/0");
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("10.10.0.0/16");
            var network2 = IPNetwork3.IPNetwork.Parse("10.10.1.0/24");
            bool result = network1.Overlap(network2);
            bool expected = true;
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("10.10.0.0/24");
            var network2 = IPNetwork3.IPNetwork.Parse("10.10.1.0/24");
            bool result = network1.Overlap(network2);
            bool expected = false;
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("10.10.1.0/24");
            var network2 = IPNetwork3.IPNetwork.Parse("10.10.0.0/16");
            bool result = network1.Overlap(network2);
            bool expected = true;
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.168.100/24");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var ipaddress = IPAddress.Parse("192.168.0.100");
            var ipaddress2 = IPAddress.Parse("192.168.1.100");

            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.0.128/25");
            var ipnetwork3 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("10.1.0.0/16");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.1.0/24");
        ...
        {
            IPNetwork3.IPNetwork iana_a_block = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
            IPNetwork3.IPNetwork iana_b_block = IPNetwork3.IPNetwork.IANA_BBLK_RESERVED1;
            IPNetwork3.IPNetwork iana_c_block = IPNetwork3.IPNetwork.IANA_CBLK_RESERVED1;
        ...
        {
            var wholeInternet = IPNetwork3.IPNetwork.Parse("0.0.0.0/0");
            byte newCidr = 2;
            ...
            foreach (IPNetwork3.IPNetwork ipnetwork in subneted)
            {
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.1.0/24");
            IPNetwork3.IPNetwork[] ipnetwork3 = IPNetwork3.IPNetwork.Supernet(new[] { ipnetwork1, ipnetwork2 });
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("192.168.0.1");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.0.254");

            IPNetwork3.IPNetwork ipnetwork = network.Supernet(network2);
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.10.0/24");

            bool supernetted = network.TrySupernet(network2, out IPNetwork3.IPNetwork ipnetwork);
        ...
        public void When_TryWideSubnet_192_168_0_0_cidr24_add_192_168_10_0_cidr24_Then_Should_Invalid()
        {
            ...
            bool wideSubnetted = IPNetwork3.IPNetwork.TryWideSubnet(new[] { network, network2 }, out IPNetwork3.IPNetwork ipnetwork);
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.1/25");
        ...
        {
            var defaultParse = IPNetwork3.IPNetwork.Parse("192.168.0.0"); // default to ClassFull
            var classFullParse = IPNetwork3.IPNetwork.Parse("192.168.0.0", CidrGuess.ClassFull);
            var classLessParse = IPNetwork3.IPNetwork.Parse("192.168.0.0", CidrGuess.ClassLess);
        ...
        public void TestIANA1()
        {
            ...
            bool expected = true;
            bool result = IPNetwork3.IPNetwork.IsIANAReserved(ipaddress);
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.66.66/24");
            bool expected = true;
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("10.10.10/18");
            bool expected = true;
            bool result = ipnetwork.IsIANAReserved();
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("172.31.10.10/24");
            bool expected = true;
            bool result = ipnetwork.IsIANAReserved();
        ...
        public void TestIANA7()
        {
            ...
            IPNetwork3.IPNetwork.IsIANAReserved(ipaddress);
        }
        ...
        public void TestIANA8()
        {
            IPNetwork3.IPNetwork ipnetwork = null;
#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.IsIANAReserved(ipnetwork);
#pragma warning restore 0618
        }
        ...
        {
            IPNetwork3.IPNetwork ipnetwork = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.IsIANAReserved(ipnetwork);
#pragma warning restore 0618
            Assert.IsTrue(result, "result");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("172.16.0.0/8");
            bool expected = false;
            bool result = ipnetwork.IsIANAReserved();
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/8");
            bool expected = false;
            bool result = ipnetwork.IsIANAReserved();
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/9");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/10");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/11");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/12");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/13");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/14");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/15");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.15.1/16");
...
#pragma warning disable 0618
            IPNetworkCollection result = IPNetwork3.IPNetwork.Subnet(ipnetwork, cidr);
#pragma warning restore 0618
        }
...
#pragma warning restore 0618
        ...
        {
            IPNetwork3.IPNetwork ipnetwork = IPNetwork3.IPNetwork.IANA_CBLK_RESERVED1;
            byte cidr = 20;
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("0.0.0.0/0");
            byte cidr = 32;
        ...
        public void TestSubnet12()
        {
            ...
            int i = -1;
            IPNetworkCollection subnets = ipnetwork.Subnet(cidr);
            foreach (IPNetwork3.IPNetwork ipn in subnets)
            {
                i++;
        ...
        public void TestSubnet13()
        {
            ...
            byte cidr = 20;
            IPNetworkCollection subnets = ipnetwork.Subnet(cidr);
            IPNetwork3.IPNetwork error = subnets[1000];
        }
        ...
        public void TestInternalSubnet1()
        {
            ...
            IPNetwork3.IPNetwork.InternalSubnet(true, null, 0, out subnets);
        ...
        {
            IPNetworkCollection subnets = null;
            IPNetwork3.IPNetwork.InternalSubnet(false, null, 0, out subnets);
        }
        ...
        public void TestTrySubnet1()
        {
            ...
            IPNetworkCollection subnets = null;
#pragma warning disable 0618
            bool subnetted = IPNetwork3.IPNetwork.TrySubnet(ipnetwork, cidr, out subnets);
#pragma warning restore 0618
        }
...
#pragma warning restore 0618
        ...
        {
            IPNetwork3.IPNetwork result;
            IPNetwork3.IPNetwork.InternalSupernet(true, null, null, out result);
        ...
        {
            IPNetwork3.IPNetwork result;
            IPNetwork3.IPNetwork.InternalSupernet(false, null, null, out result);
        }
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.2.0/24");
            var expected = IPNetwork3.IPNetwork.Parse("192.168.0.0/23");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        ...
        public void Issue33__TestWideSubnet__Bug_or_default_behavior()
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.2.0/24");
            var expected = IPNetwork3.IPNetwork.Parse("192.168.0.0/22");
            var widenetwork = IPNetwork3.IPNetwork.WideSubnet(new[] { network1, network2 });
        ...
        public void Issue162__Test_IPrangeToCIDRnotation()
        {
            ...
            var final = IPNetwork3.IPNetwork.WideSubnet(network1, network2);
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            var expected = IPNetwork3.IPNetwork.Parse("192.168.0.0/23");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            IPNetwork3.IPNetwork network2 = null;
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        }
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.1.1/25");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        }
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.5.1/24");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        }
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.0.1/25");
            var expected = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/25");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var expected = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
...
#pragma warning disable CS0618 // Type or member is obsolete
            var supernet = IPNetwork3.IPNetwork.Supernet(network1, network2);
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.2.1/24");
            IPNetwork3.IPNetwork supernet = network1.Supernet(network2);
        }
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("200.16.0.0/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("200.16.1.0/24");
            var ipnetwork3 = IPNetwork3.IPNetwork.Parse("200.16.2.0/24");
            var ipnetwork4 = IPNetwork3.IPNetwork.Parse("200.16.3.0/24");

            IPNetwork3.IPNetwork result = IPNetwork3.IPNetwork.Supernet(new[] { ipnetwork1, ipnetwork2, ipnetwork3, ipnetwork4 })[0];
            var expected = IPNetwork3.IPNetwork.Parse("200.16.0.0/22");
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("1.1.0.0/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("1.2.1.0/24");

            IPNetwork3.IPNetwork result = IPNetwork3.IPNetwork.Supernet(new[] { ipnetwork1, ipnetwork2 })[0];
            var expected = IPNetwork3.IPNetwork.Parse("1.1.0.0/24");
        ...
        public void TestTrySupernet1()
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            var supernetExpected = IPNetwork3.IPNetwork.Parse("192.168.0.0/23");
            IPNetwork3.IPNetwork supernet;
            bool parsed = true;
...
#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.TrySupernet(network1, network2, out supernet);
#pragma warning restore 0618
        }
...
#pragma warning restore 0618
        ...
        public void TestTrySupernet3()
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            IPNetwork3.IPNetwork network2 = null;
            IPNetwork3.IPNetwork supernetExpected = null;
            IPNetwork3.IPNetwork supernet;
            bool parsed = false;
            bool result = network1.TrySupernet(network2, out supernet);
        ...
        public void TestTrySupernet6()
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.0.1/25");
            var supernetExpected = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            IPNetwork3.IPNetwork supernet;
            bool parsed = true;
            bool result = network1.TrySupernet(network2, out supernet);
        ...
        public void TestTrySupernet9()
        {
            var network1 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.2.1/24");
            IPNetwork3.IPNetwork[] network3 = new[] { network1, network2 };
            IPNetwork3.IPNetwork[] supernetExpected = new[] { network1, network2 };
            IPNetwork3.IPNetwork[] supernet;
            bool parsed = true;
            bool result = IPNetwork3.IPNetwork.TrySupernet(network3, out supernet);
        ...
        public void TestTrySupernet10()
        {
            ...
            var network2 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            IPNetwork3.IPNetwork[] network3 = new[] { network1, network2 };
            IPNetwork3.IPNetwork[] supernetExpected = new[] { IPNetwork3.IPNetwork.Parse("192.168.0.0/23") };
            IPNetwork3.IPNetwork[] supernet;
            bool parsed = true;
            bool result = IPNetwork3.IPNetwork.TrySupernet(network3, out supernet);
        ...
        {
            IPNetwork3.IPNetwork[] network3 = null;
            IPNetwork3.IPNetwork[] supernetExpected = new[] { IPNetwork3.IPNetwork.Parse("192.168.0.0/23") };
            IPNetwork3.IPNetwork[] supernet;
            bool parsed = false;
            bool result = IPNetwork3.IPNetwork.TrySupernet(network3, out supernet);
        ...
        public void TestTrySupernetArray()
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.1.0/24");
            var ipnetwork3 = IPNetwork3.IPNetwork.Parse("192.168.2.0/24");
            var ipnetwork4 = IPNetwork3.IPNetwork.Parse("192.168.3.0/24");

            IPNetwork3.IPNetwork[] ipnetworks = { ipnetwork1, ipnetwork2, ipnetwork3, ipnetwork4 };
            IPNetwork3.IPNetwork[] expected = { IPNetwork3.IPNetwork.Parse("192.168.0.0/22") };

            IPNetwork3.IPNetwork[] result = IPNetwork3.IPNetwork.Supernet(ipnetworks);
        ...
        {
            IPNetwork3.IPNetwork[] ipnetworks = { };
            IPNetwork3.IPNetwork[] expected = { };
        ...
        {
            IPNetwork3.IPNetwork[] ipnetworks = null;
            IPNetwork3.IPNetwork[] result = IPNetwork3.IPNetwork.Supernet(ipnetworks);
        }
        ...
        {
            IPNetwork3.IPNetwork ipnetwork1 = null;
            IPNetwork3.IPNetwork ipnetwork2 = null;
            IPNetwork3.IPNetwork ipnetwork3 = null;
            IPNetwork3.IPNetwork ipnetwork4 = null;
        ...
        public void TestTrySupernetArray4()
        {
            ...
            IPNetwork3.IPNetwork[] ipnetworks = subnetted.ToArray();
            Assert.AreEqual(256, ipnetworks.Length, "subnet");

            IPNetwork3.IPNetwork[] expected = { IPNetwork3.IPNetwork.Parse("192.168.0.0/24") };
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/16");
            IPNetworkCollection subnetted = ipnetwork1.Subnet(24);
            IPNetwork3.IPNetwork[] ipnetworks = subnetted.ToArray();
            Assert.AreEqual(256, ipnetworks.Length, "subnet");

            IPNetwork3.IPNetwork[] expected = { IPNetwork3.IPNetwork.Parse("192.168.0.0/16") };
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("192.168.0.0/8");
            IPNetworkCollection subnetted = ipnetwork1.Subnet(24);
            IPNetwork3.IPNetwork[] ipnetworks = subnetted.ToArray();
            Assert.AreEqual(65536, ipnetworks.Length, "subnet");

            IPNetwork3.IPNetwork[] expected = { IPNetwork3.IPNetwork.Parse("192.0.0.0/8") };
        ...
        public void TestTrySupernetArray7()
        {
            IPNetwork3.IPNetwork[] ipnetworks =
            {
                IPNetwork3.IPNetwork.Parse("10.0.2.2/24"),
                IPNetwork3.IPNetwork.Parse("192.168.0.0/24"),
                IPNetwork3.IPNetwork.Parse("192.168.1.0/24"),
                IPNetwork3.IPNetwork.Parse("192.168.2.0/24"),
                IPNetwork3.IPNetwork.Parse("10.0.1.1/24"),
                IPNetwork3.IPNetwork.Parse("192.168.3.0/24"),
            };

            IPNetwork3.IPNetwork[] expected =
            {
                IPNetwork3.IPNetwork.Parse("10.0.1.0/24"),
                IPNetwork3.IPNetwork.Parse("10.0.2.0/24"),
                IPNetwork3.IPNetwork.Parse("192.168.0/22"),
            };
        ...
        public void TestTrySupernetArray8()
        {
            IPNetwork3.IPNetwork[] ipnetworks =
            {
                ...
                IPNetwork3.IPNetwork.Parse("10.0.1.1/24"),
                IPNetwork3.IPNetwork.Parse("192.168.3.0/24"),
                IPNetwork3.IPNetwork.Parse("10.6.6.6/8"),
            };

            IPNetwork3.IPNetwork[] expected =
            {
                IPNetwork3.IPNetwork.Parse("10.0.0.0/8"),
                IPNetwork3.IPNetwork.Parse("192.168.0/22"),
            };
        ...
        public void TestTrySupernetArray9()
        {
            IPNetwork3.IPNetwork[] ipnetworks =
            {
                ...
                IPNetwork3.IPNetwork.Parse("192.168.3.0/24"),
                IPNetwork3.IPNetwork.Parse("10.6.6.6/8"),
                IPNetwork3.IPNetwork.Parse("11.6.6.6/8"),
                IPNetwork3.IPNetwork.Parse("12.6.6.6/8"),
            };

            IPNetwork3.IPNetwork[] expected =
            {
                IPNetwork3.IPNetwork.Parse("10.0.0.0/7"),
                IPNetwork3.IPNetwork.Parse("12.0.0.0/8"),
                IPNetwork3.IPNetwork.Parse("192.168.0/22"),
            };
        ...
        public void TestTrySupernetArray10()
        {
            ...
            {
                IPNetwork3.IPNetwork.Parse("10.0.2.2/24"),
                IPNetwork3.IPNetwork.Parse("10.0.2.2/23"),
            };
        ...
        public void TestWideSubnet1()
        {
            ...
            var expected = IPNetwork3.IPNetwork.Parse("192.168.168.0/24");

            var wideSubnet = IPNetwork3.IPNetwork.WideSubnet(start, end);
        ...
        public void TestWideSubnet7()
        {
            ...
            var expected = IPNetwork3.IPNetwork.Parse("0.0.0.0/8");
        ...
        public void TestWideSubnet8()
        {
            ...
            var expected = IPNetwork3.IPNetwork.Parse("0.0.0.0/5");
        ...
        public void TestWideSubnet9()
        {
            ...
            string firt = IPNetwork3.IPNetwork.Parse(start).FirstUsable.ToString();
            string last = IPNetwork3.IPNetwork.Parse(end).LastUsable.ToString();

            var expected = IPNetwork3.IPNetwork.Parse("200.16.0.0/22");

            var wideSubnet = IPNetwork3.IPNetwork.WideSubnet(firt, last);
            Assert.AreEqual(expected, wideSubnet, "wideSubnet");
        }
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr(null, out cidr);
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr("10.0.0.0", out cidr);
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr("172.0.0.0", out cidr);
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr("192.0.0.0", out cidr);
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr("224.0.0.0", out cidr);
        ...
        {
            byte cidr;
            bool parsed = IPNetwork3.IPNetwork.TryGuessCidr("240.0.0.0", out cidr);
        ...
        public void Print()
        {
            var ipn = IPNetwork3.IPNetwork.Parse("0.0.0.0/0");
...
".Replace("\r", string.Empty);
        ...
        {
            IPNetwork3.IPNetwork ipn = null;
#pragma warning disable 0618
            string print = IPNetwork3.IPNetwork.Print(ipn);
#pragma warning restore 0618
        }
        ...
        {
            IPNetwork3.IPNetwork ipn = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
#pragma warning disable 0618
            string print = IPNetwork3.IPNetwork.Print(ipn);
#pragma warning restore 0618
        }
        ...
        public void TestSort1()
        {
            ...
            var ipns = new List<IPNetwork3.IPNetwork>();
            foreach (string ip in ips)
            {
                IPNetwork3.IPNetwork ipn;
                if (IPNetwork3.IPNetwork.TryParse(ip, 32, out ipn))
                {
                    ipns.Add(ipn);
                }
            }
        ...
        public void TestSort2()
        {
            ...
            {
                IPNetwork3.IPNetwork ipn;
                if (IPNetwork3.IPNetwork.TryParse(ip, out ipn))
                {
                    ipns.Add(ipn);
                }
            }
        ...
        public void TryWideSubnet1()
        {
            ...
            IPNetwork3.IPNetwork ipnetwork = null;
            bool wide = IPNetwork3.IPNetwork.TryWideSubnet(ipns.ToArray(), out ipnetwork);
        ...
        {
            IPNetwork3.IPNetwork ipnetwork = null;
            bool wide = IPNetwork3.IPNetwork.TryWideSubnet(null, out ipnetwork);
            Assert.AreEqual(false, wide, "wide");
        }
        ...
        public void WideSubnet1()
        {
            ...
            var ipnetwork = IPNetwork3.IPNetwork.WideSubnet(ipns.ToArray());
            Assert.AreEqual("0.0.0.0/0", ipnetwork.ToString(), "ipnetwork");
        }
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.WideSubnet(null);
        }
        ...
        public void WideSubnetMixed()
        {
            var ipns = new List<IPNetwork3.IPNetwork>
            {
                IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1,
                IPNetwork3.IPNetwork.Parse("2001:0db8::/64"),
            };
            var ipnetwork = IPNetwork3.IPNetwork.WideSubnet(ipns.ToArray());
        }
        ...
        {
            byte[] resut = IPNetwork3.IPNetwork.Resize(new byte[33], Sockets.AddressFamily.InterNetwork);
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/32");
            int total = 1;
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/31");
            int total = 2;
            Assert.AreEqual(total, network.Total, "Total");
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/30");
            int total = 4;
            Assert.AreEqual(total, network.Total, "Total");
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/24");
            int total = 256;
            Assert.AreEqual(total, network.Total, "Total");
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/16");
            int total = 65536;
            Assert.AreEqual(total, network.Total, "Total");
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/8");
            int total = 16777216;
            Assert.AreEqual(total, network.Total, "Total");
        }
        ...
        {
            var network = IPNetwork3.IPNetwork.Parse("0.0.0.0/0");
        ...
        public void TryParseCidr1()
        {
            ...
            byte? cidr;
            byte? result = 0;
            bool parsed = IPNetwork3.IPNetwork.TryParseCidr(sidr, Sockets.AddressFamily.InterNetwork, out cidr);
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/16");
            var ipn2 = IPNetwork3.IPNetwork.Parse("10.0.0.2/16");
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/16");
            object ipn2 = (object)IPNetwork3.IPNetwork.Parse("10.0.0.2/16");
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/16");
            IPNetwork3.IPNetwork ipn2 = null;
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/16");
            int comparison = IPNetwork3.IPNetwork.Compare(null, ipn1);
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/16");
            var ipn2 = IPNetwork3.IPNetwork.Parse("20.0.0.1/16");
            int comparison = IPNetwork3.IPNetwork.Compare(ipn1, ipn2);
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/32");
            var ipn2 = IPNetwork3.IPNetwork.Parse("10.0.0.2/32");
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.100/32");
            var ipn2 = IPNetwork3.IPNetwork.Parse("10.0.0.2/32");
        ...
        {
            var ipn1 = IPNetwork3.IPNetwork.Parse("10.0.0.1/32");
            var ipn2 = IPNetwork3.IPNetwork.Parse("10.0.0.1/32");
