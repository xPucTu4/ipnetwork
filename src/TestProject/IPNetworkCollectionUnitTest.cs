...
namespace System.Net.TestProject
{
    ...
    public class IPNetworkCollectionUnitTest
    {
        ...
        {
            var ipn = new IPNetworkCollection(IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1, 33);
        }
        ...
        {
            var ipn = new IPNetworkCollection(IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1, 2);
        }
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("192.168.0.0/32");
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("192.168.1.0/29");
            using (IPNetworkCollection ipns = ipn.Subnet(32))
            {
                IPNetwork3.IPNetwork ipn0 = ipns.Current;
                ipns.MoveNext();
                ipns.Reset();
                IPNetwork3.IPNetwork ipn1 = ipns.Current;
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("192.168.1.0/30");
            using (IPNetworkCollection ipns = ipn.Subnet(32))
            {
