...
namespace System.Net.TestProject
{
    ...
    public class TryParseUnitTest
    {
        ...
        {
            IPAddress ip = null;
            bool parsed = IPNetwork3.IPNetwork.TryParse(ip, ip, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse(string.Empty, 0, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse(null, 0, out IPNetwork3.IPNetwork ipnet);
        ...
        public void TestTryParseIPAddressNetmaskANE5()
        {
            ...
            bool parsed = IPNetwork3.IPNetwork.TryParse(n, n, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse(IPAddress.Parse("10.10.10.10"), null, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", null, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse("x.x.x.x", "x.x.x.x", out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", "x.x.x.x", out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse("x.x.x.x", 0, out IPNetwork3.IPNetwork ipnet);
        ...
        {
            bool parsed = IPNetwork3.IPNetwork.TryParse("0.0.0.0", 33, out IPNetwork3.IPNetwork ipnet);
        ...
        public void TestTryParseIPAddressNetmask()
        {
            ...
            bool parsed = IPNetwork3.IPNetwork.TryParse(ipaddress, netmask, out IPNetwork3.IPNetwork ipnetwork);
        ...
        public void TestTryParseString1()
        {
            ...
            bool parsed = IPNetwork3.IPNetwork.TryParse(ipaddress, out IPNetwork3.IPNetwork ipnetwork);
        ...
        {
            bool parsed1 = IPNetwork3.IPNetwork.TryParse("g001:02b8::/64", out IPNetwork3.IPNetwork ipnetwork1);
            bool parsed2 = IPNetwork3.IPNetwork.TryParse("1:2b8::/64", out IPNetwork3.IPNetwork ipnetwork2);
        ...
        {
            bool result = IPNetwork3.IPNetwork.TryParse(ipnetwork, sanitanize, out IPNetwork3.IPNetwork ipnetwork1);
