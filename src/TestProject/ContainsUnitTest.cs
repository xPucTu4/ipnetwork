...
namespace System.Net.TestProject
{
    ...
    public class ContainsUnitTest
    {
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.0.1/24");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.1/16");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.0.1/16");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("10.10.10.0/24");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("192.168.1.1/24");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("192.168.0.0/16");
...
#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.Contains(ipnetwork, ipnetwork2);
#pragma warning restore 0618
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.IANA_CBLK_RESERVED1;
            var ipnetwork2 = IPNetwork3.IPNetwork.IANA_CBLK_RESERVED1;
...
#pragma warning disable 0618
            bool result = IPNetwork3.IPNetwork.Contains(ipnetwork, ipaddress);
#pragma warning restore 0618
        }
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.IANA_ABLK_RESERVED1;
...
#pragma warning restore 0618
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse(contains1);
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse(contains1);
            var ipaddress = IPNetwork3.IPNetwork.Parse(contains2);
