// <copyright file="WildcardMaskUnitTest.cs" company="IPNetwork">
...
namespace System.Net.TestProject
{
    ...
    public class WildcardMaskUnitTest
    {
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("1.1.1.1/0");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("1.1.1.1/32");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse($"1.1.1.1/{netmask}");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse($"1.1.1.1/{cidr}");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("::/128");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse($"::/{netmask}");
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse($"::/{cidr}");

            int cidr2 = (int)ipnetwork.Cidr;
            var expectedipv6 = IPAddress.Parse(expected);
            var expectedcidr = IPNetwork3.IPNetwork.ToBigInteger(expectedipv6);
            IPAddress wildcardmask = ipnetwork.WildcardMask;
            var wildcardcidr = IPNetwork3.IPNetwork.ToBigInteger(wildcardmask);
