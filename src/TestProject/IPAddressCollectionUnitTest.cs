...
#pragma warning disable CS0618 // Type or member is obsolete
            using (IPAddressCollection ips = IPNetwork3.IPNetwork.ListIPAddress(ipn))
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("192.168.1.0/31");
            using (IEnumerator<IPAddress> ips = ipn.ListIPAddress())
            {
                Assert.IsTrue(ips.MoveNext());
                Assert.IsTrue(ips.MoveNext());
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("::/125");
            using (IPAddressCollection ips = ipn.ListIPAddress())
            {
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("::/0");
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("::/127");
            using (IEnumerator<IPAddress> ips = ipn.ListIPAddress())
            {
                Assert.IsTrue(ips.MoveNext());
                Assert.IsTrue(ips.MoveNext());
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("::1");
        ...
        {
            var ipn = IPNetwork3.IPNetwork.Parse("192.168.1.0/32");
            using (IPAddressCollection ips = ipn.ListIPAddress(FilterEnum.Usable))
            {
                Assert.AreEqual(0, ips.Count, "Count");
            }
