...
namespace System.Net.TestProject
{
    ...
    public class GetHashCodeUnitTest
    {
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("0.0.1.1/0");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("0.0.1.1/0");
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("0.0.0.0/1");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("0.0.0.0/1");
            int hashCode1 = ipnetwork1.GetHashCode();
            int hashCode2 = ipnetwork2.GetHashCode();
            Assert.AreEqual(hashCode1, hashCode2, "hashcode");
        }
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("0.0.0.0/32");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("0.0.0.0/32");
            int hashCode1 = ipnetwork1.GetHashCode();
            int hashCode2 = ipnetwork2.GetHashCode();
            Assert.AreEqual(hashCode1, hashCode2, "hashcode");
        }
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("0.0.1.1/0");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("1.1.1.1/0");
            int hashCode1 = ipnetwork1.GetHashCode();
            int hashCode2 = ipnetwork2.GetHashCode();
            Assert.AreEqual(hashCode1, hashCode2, "hashcode");
        }
        ...
        {
            var ipnetwork1 = IPNetwork3.IPNetwork.Parse("0.0.0.0/1");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("1.0.0.0/1");
            int hashCode1 = ipnetwork1.GetHashCode();
            int hashCode2 = ipnetwork2.GetHashCode();
            Assert.AreEqual(hashCode1, hashCode2, "hashcode");
        }
        ...
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("1.0.0.0/1");
        ...
        public void TestGetHashCode_Dictionary_failed()
        {
            var ipnetwork = IPNetwork3.IPNetwork.Parse("1.0.0.0/1");
            var ipnetwork2 = IPNetwork3.IPNetwork.Parse("1.0.0.0/1");
            var dic = new Dictionary<IPNetwork3.IPNetwork, int>();
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("::/32");
            var network2 = IPNetwork3.IPNetwork.Parse("0.0.0.0/32");
