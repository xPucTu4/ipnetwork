...
namespace System.Net.TestProject
{
    ...
    public class EqualsUnitTest
    {
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("::1/128");
            var network2 = IPNetwork3.IPNetwork.Parse("::1/128");
            bool result = network1.Equals(network2);
            bool expected = true;
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("::1/128");
            var network2 = IPNetwork3.IPNetwork.Parse("::1/127");
            bool result = network1.Equals(network2);
            bool expected = false;
        ...
        {
            var network1 = IPNetwork3.IPNetwork.Parse("::1/128");
            var network2 = IPNetwork3.IPNetwork.Parse("::10/128");
            bool result = network1.Equals(network2);
            bool expected = false;
