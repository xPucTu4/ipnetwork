...
namespace System.Net.ConsoleApplication
{
    public class ProgramContext
    {
        ...
        public IPNetwork3.IPNetwork ContainNetwork { get; set; }

        public IPNetwork3.IPNetwork OverlapNetwork { get; set; }

        public IPNetwork3.IPNetwork SubtractNetwork { get; set; }
        ...
        public IPNetwork3.IPNetwork[] Networks { get; set; }
    }
}
